...
JS_PUBLIC_API bool JS::EnqueueMicroTask(JSContext* cx, const JS::GenericMicroTask& entry) {
...
JS_PUBLIC_API bool JS::PrependMicroTask(JSContext* cx, const JS::GenericMicroTask& entry) {
...
JS_PUBLIC_API JS::GenericMicroTask JS::DequeueNextDebuggerMicroTask(JSContext* cx) {
...
JS_PUBLIC_API JS::GenericMicroTask JS::DequeueNextRegularMicroTask(JSContext* cx) {
